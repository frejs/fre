...
exports.ele = exports.first = exports.vm = void 0;
...
function mount(vnode, el) {
  exports.ele = ele = el;
  el.innerHTML = '';
  exports.first = first = vnode.type();
  exports.vm = vm = vnode;
...
exports.diff = diff;
exports.oldDom = void 0;
var ATTRS = 'ATTRS';
var REMOVE = 'REMOVE';
var TEXT = 'TEXT';
var REPLACE = 'REPLACE'; // let Index = 0

var oldDom;
exports.oldDom = oldDom;

function diff(oldTree, newTree) {
  exports.oldDom = oldDom = newTree;
  var index = 0;
  var patches = {};
...
function walk(oldNode, newNode, index, patches) {
  ...
  if (typeof oldNode === 'string' && typeof newNode === 'string' || typeof oldNode === 'number' && typeof oldNode === 'number') {
    if (oldNode !== newNode) {
      currentPatches.push({
        type: TEXT,
        text: newNode
...
function useState(state) {
  ...
  var proxy = new Proxy(state, {
    ...
    set: function set(obj, key, val) {
      ...
      if (!once) {
        oldTree = _render.first;
        once = true;
      } else {
        oldTree = _diff.oldDom;
      }
...
exports.html = html;
},{"./html":"src/html.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
function counter() {
  var state = (0, _hooks.useState)({
    count: 0
  });
  return (0, _h.html)(_templateObject(), state.count, function () {
    state.count++;
  }, function () {
    state.count--;
  });
...
(0, _render.mount)((0, _h.html)(_templateObject2(), counter), document.body); // hooks √
// Proxy √
// tagged template √
// vdom diff √
},{"./src/hooks":"src/hooks.js","./src/h":"src/h.js","./src/render":"src/render.js"}],"C:/Users/admin/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/fre1.e31bb0bc.map