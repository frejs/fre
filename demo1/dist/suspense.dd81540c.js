...
},{"./h":"../src/h.ts","./reconciler":"../src/reconciler.ts","./hooks":"../src/hooks.ts","./scheduler":"../src/scheduler.ts","./suspense":"../src/suspense.ts","./type":"../src/type.ts"}],"src/suspense.tsx":[function(require,module,exports) {
"use strict";
...
var Lazy = index_1.lazy(function () {
  return new Promise(function (resolve) {
    return setTimeout(function () {
      return resolve({
        default: function _default() {
          return index_1.h("div", null, "Hello");
        }
      });
    }, 1000);
  });
...
function App() {
  return index_1.h(index_1.Suspense, {
    fallback: index_1.h("div", null, "Loading...")
  }, index_1.h(Lazy, null));
}

index_1.render(index_1.h(App, null), document.getElementById('root'));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "61008" + '/');
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","src/suspense.tsx"], null)
//# sourceMappingURL=/suspense.dd81540c.js.map