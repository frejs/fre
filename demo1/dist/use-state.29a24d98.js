...
},{"./h":"../src/h.ts","./reconciler":"../src/reconciler.ts","./hooks":"../src/hooks.ts","./scheduler":"../src/scheduler.ts","./suspense":"../src/suspense.ts","./type":"../src/type.ts"}],"src/use-state.tsx":[function(require,module,exports) {
"use strict";
...
function App() {
  var _index_1$useState = index_1.useState(0),
      ...
      setCount = _index_1$useState2[1];

  var _index_1$useState3 = index_1.useState(0),
      _index_1$useState4 = _slicedToArray(_index_1$useState3, 2),
      two = _index_1$useState4[0],
      setTwo = _index_1$useState4[1];

  index_1.useEffect(function () {
    setTimeout(function () {
      setCount(count + 1);
    }, 3000);
  }, []);
  return index_1.h(index_1.Fragment, null, index_1.h(Nil, {
    count: count
  }), index_1.h("button", {
...
function Nil(props) {
  ...
  var _index_1$useState5 = index_1.useState(0),
      _index_1$useState6 = _slicedToArray(_index_1$useState5, 2),
      count = _index_1$useState6[0],
      setCount = _index_1$useState6[1];

  return index_1.h("button", {
    onClick: function onClick() {
      return setCount(function (c) {
        return c + 1;
      });
...
index_1.render(index_1.h(App, null), document.body);
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","src/use-state.tsx"], null)
//# sourceMappingURL=/use-state.29a24d98.js.map