...
var useReducer = function useReducer(reducer, initState) {
  ...
  return [hook[0] || (hook[0] = initState), function (value) {
...
var scheduleWork = function scheduleWork(callback, lane) {
  var job = {
    callback: callback,
    lane: lane
  };
...
var sortAndPeek = function sortAndPeek(queue) {
  return queue[0];
};
...
var dispatchUpdate = function dispatchUpdate(fiber) {
  if (fiber && !(fiber.lane & LANE.DIRTY)) {
    ...
    fiber.sibling = null;
    (0, _scheduler.scheduleWork)(reconcileWork.bind(null, fiber), fiber.lane);
  }
};
...
},{"./h":"../src/h.ts","./reconciler":"../src/reconciler.ts","./hooks":"../src/hooks.ts","./scheduler":"../src/scheduler.ts","./suspense":"../src/suspense.ts","./type":"../src/type.ts"}],"src/benchmark.tsx":[function(require,module,exports) {
"use strict";
  ...
  switch (action.type) {
    ...
    case "SWAP_ROWS":
      return data.length > 998 ? {
        data: [data[0], data[998]].concat(_toConsumableArray(data.slice(2, 998)), [data[1], data[999]])
      } : state;
    ...
    case "REMOVE":
      ...
      return {
        data: [].concat(_toConsumableArray(data.slice(0, idx)), _toConsumableArray(data.slice(idx + 1))),
        selected: selected
      };
...
var Jumbotron = function Jumbotron(_ref3) {
  ...
  return src_1.h("div", {
    ...
    className: "col-md-6"
  }, src_1.h("h1", null, "React Hooks keyed")), src_1.h("div", {
    className: "col-md-6"
  }, src_1.h("div", {
    className: "row"
  }, src_1.h(Button, {
...
var Main = function Main() {
  var _src_1$useReducer = src_1.useReducer(listReducer, {
    data: [],
    selected: 0
  }),
      _src_1$useReducer2 = _slicedToArray(_src_1$useReducer, 2),
      state = _src_1$useReducer2[0],
      dispatch = _src_1$useReducer2[1];

  var MemoJumbotton = src_1.useMemo(function () {
    return Jumbotron;
  }, []);
  src_1.useEffect(stopMeasure);
  return src_1.h("div", {
    className: "container"
  }, src_1.h(MemoJumbotton, {
    dispatch: dispatch
  }), src_1.h("table", {
    className: "table table-hover table-striped test-data"
  }, src_1.h("tbody", null, state.data.map(function (item) {
    return src_1.h(Row, {
      key: item.id,
      item: item,
...
src_1.render(src_1.h(Main, null), document.getElementById("root"));
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","src/benchmark.tsx"], null)
//# sourceMappingURL=/benchmark.654a58d1.js.map