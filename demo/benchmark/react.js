...
*/
    ...
    while (
      ...
      if (callback !== null) {
        ...
        if (typeof continuationCallback === 'function') {
          currentTask.callback = continuationCallback        } else {
        }
      } else {
        pop(taskQueue)
      }
  ...
  function createEventResponder (displayName, responderConfig) {
    ...
    var onEvent = responderConfig.onEvent

    var onMount = responderConfig.onMount

    var onUnmount = responderConfig.onUnmount

    var onRootEvent = responderConfig.onRootEvent

    var rootEventTypes = responderConfig.rootEventTypes

    var targetEventTypes = responderConfig.targetEventTypes

    var targetPortalPropagation = responderConfig.targetPortalPropagation
    var eventResponder = {
